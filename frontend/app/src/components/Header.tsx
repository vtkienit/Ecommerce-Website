        ...
        <div className="mx-auto flex max-w-[1280px] items-center justify-between px-3 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className="absolute -right-1.5 -top-2 rounded-full bg-primary px-1.5 py-0.5 text-xs text-white">
                2
              </span>
            </button>
        ...
        <div className="box-border p-2">
          <nav className="flex flex-col" aria-label={t("menu")}>
            ...
            <ul className="m-0 flex list-none flex-col p-0">
              ...
              <li className={mobileItem}>
                <Link className={mobileLink} to="/manage-order" onClick={closeMenu}>
                  {t("manageOrder")}
                </Link>
              </li>
            </ul>
